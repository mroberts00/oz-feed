...
RSpec.describe "business_profiles/new", type: :view do
  before(:each) do
    assign(:business_profile, BusinessProfile.new(
      :business => nil,
      :name => "MyString",
      :about => "MyText",
  ...
  it "renders new business_profile form" do
    render

    assert_select "form[action=?][method=?]", business_profiles_path, "post" do
